...
G4VPhysicalVolume* DET01DetectorConstruction::Construct()
{
  ...
  // Detector Dimensions
  // 122.5 mm x 152.5 mm x 152.5 mm
  // X = 122.5, Y = 152.5, Z = 152.5
  G4double scinX = 122.5*mm;
  G4double scinY = 152.5*mm;
  G4double scinZ = 152.5*mm;
...
void DET01DetectorConstruction::ConstructSDandField()
{
  ...
  if (fPhotocathodeLogical) {
      G4String sdName = "DET01/Photocathode";
  ...
  if (scinLV) {
      G4String scinSDName = "DET01/Scintillator";
